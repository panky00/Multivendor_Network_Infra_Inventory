...
input_file = open("C:\DEV\RAW_DATA\cisco-XR-version.txt")
...
template = open("C:\DEV\SCRIPT\cisco_xr_show_version.template")
...
outfile_name = open("cisco-xr-version"+datestring+".csv", "w+")
