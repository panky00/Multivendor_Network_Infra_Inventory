...
input_file = open("C:\DEV\RAW_DATA\junos-inventory.txt")
...
template = open("C:\DEV\SCRIPT\junos_inventory.textfsm")
...
outfile_name = open("junos-inventory"+datestring+".csv", "w+")
