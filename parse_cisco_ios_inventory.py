...
input_file = open("C:\DEV\RAW_DATA\cisco-ios-inventory.txt")
...
os.chdir(r'C:\DEV\PARSE_DATA\7600_inventory')
outfile_name = open("cisco-ios-inventory"+datestring+".csv", "w+")
